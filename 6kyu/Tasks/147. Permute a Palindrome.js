...
//Solution:
const permuteAPalindrome = ([...input], odd = 0) => {
    new Set(input).forEach(el => input.filter(a => a === el).length % 2 ? odd++ : 0)
    return odd < 2
}