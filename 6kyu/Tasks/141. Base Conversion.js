//Task: In this kata you have to implement a base converter, which converts positive integers between arbitrary bases / alphabets. Here are some pre-defined alphabets:
//
// var Alphabet = {
//   BINARY:        '01',
//   OCTAL:         '01234567',
...
function convert(input, source, target) {
    ...
    for (let d = 0; d < input.length; d++) {
        acc = acc * base_in
        acc = acc + source.indexOf(input[d])
    }
    while (acc !== 0) {
