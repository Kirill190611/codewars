//Task: In this kata you're expected to sort an array of 32-bit integers in ascending order of the number of on bits they have.
//
...
const sortByBit = arr => {
    ...
    return arr.sort((a, b) => a - b).sort((a, b) => getResult(a) - getResult(b));
}